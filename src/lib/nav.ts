...
const NAV_ADMIN: NavGroup[] = [
  ...
  {
    grp: "Conta",
    items: [{ id: "configuracoes", label: "Configurações", icon: "settings", href: "/configuracoes" }],
  },
];
...
const NAV_PROF: NavGroup[] = [
  {
    ...
    items: [
      { id: "home", label: "Início", icon: "home", href: "/home" },
      {
        ...
        icon: "users",
        children: [{ id: "pacientes-lista", label: "Lista de Pacientes", href: "/pacientes" }],
      },
    ],
  },
  {
  ...
  {
    grp: "Operação",
    items: [{ id: "atendimento", label: "Meu Atendimento", icon: "check", href: "/atendimento" }],
  },
  {
    grp: "Conta",
    items: [{ id: "configuracoes", label: "Configurações", icon: "settings", href: "/configuracoes" }],
