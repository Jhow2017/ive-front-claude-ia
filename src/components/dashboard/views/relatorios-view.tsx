...
const REPORTS = [
    {
        Ic: FileText,
        title: "Relatório Semestral · Fonoaudiologia",
        meta: "Dra. Ana Lima · Abr 2026",
        badge: "Novo",
        v: "green" as const,
    },
    {
        ...
        meta: "Dr. Rafael Cunha · Abr 2026",
        badge: "Novo",
        v: "green" as const,
    },
    {
        Ic: FileText,
        title: "Evolução — Terapia Ocupacional",
        meta: "Profa. Cíntia · Mar 2026",
        badge: "Lido",
        v: "gray" as const,
    },
    {
        Ic: BarChart3,
        title: "Relatório de Progresso Geral",
        meta: "Equipe · Fev 2026",
        badge: "Lido",
        v: "gray" as const,
    },
    {
        Ic: FileText,
        title: "Plano Terapêutico 2025",
        meta: "Equipe · Jan 2025",
        badge: "Lido",
        v: "gray" as const,
    },
    {
        ...
        <>
            <div>
                ...
                <div className="text-[13px] text-(--color-muted) mt-1">
                    Documentos clínicos e avaliações
                </div>
            </div>
