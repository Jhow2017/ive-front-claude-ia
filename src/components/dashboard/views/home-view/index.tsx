...
const FAM_METRICS = [
    ...
    {
        l: "Áreas em atendimento",
        v: "3",
        d: "Fono, TO, Psicologia",
        cls: "neutral",
        delta: "Ativo",
    },
...
const OBS = [
    {
        ...
        n: "Dra. Ana Lima",
        r: "Fonoaudióloga",
        m: "Sessão de 24/04: boa resposta ao protocolo de nomeação.",
        t: "há 2 dias",
    },
    {
        av: 1,
        n: "Profa. Cíntia",
        r: "Terapeuta Ocup.",
        m: "Integração sensorial — boa tolerância ao toque hoje.",
        t: "há 4 dias",
    },
    {
        av: 2,
        n: "Dr. Rafael Cunha",
        r: "Neuropsicólogo",
        m: "Reavaliação cognitiva marcada para 15/05.",
        t: "há 1 sem",
    },
];
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex justify-between items-baseline mb-1">
                                                <div>
                                                    ...
                                                    <span className="text-[11px] text-(--color-muted) ml-2">
                                                        {s.p} pacientes
                                                    </span>
                                                </div>
                                                <span className="text-[13px] font-bold text-(--color-g600)">
                                                    {s.pct}%
                                                </span>
                                            </div>
                        ...
                        <CardContent>
                            ...
                            <div className="flex flex-col gap-2.5">
                                {[
                                    ...
                                    <div
                                        key={i}
                                        className="bg-(--color-g50) border border-(--color-g100) rounded-[10px] px-3.5 py-3 flex gap-2.5 items-center"
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="text-[11px] text-(--color-g600) mt-0.5 font-semibold">
                                                {p.t}
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <tbody>
                                {PROX.map((r, i) => (
                                    <tr key={i} className="hover:bg-(--color-g50)">
                                        <td className="py-3 text-[13px] font-semibold border-t border-(--color-border-soft)">
                                            {r.p}
                                        </td>
                                        <td className="py-3 text-[13px] text-(--color-muted) border-t border-(--color-border-soft)">
                                            {r.e}
                                        </td>
                                        <td className="py-3 text-[13px] text-(--color-muted) border-t border-(--color-border-soft)">
                                            {r.h}
