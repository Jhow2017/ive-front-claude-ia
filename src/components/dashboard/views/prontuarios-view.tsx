    ...
    <>
      <div className="flex justify-between items-start flex-wrap gap-3">
        <div>
          ...
          <div className="text-[13px] text-(--color-muted) mt-1">Lucas Costa · CID F84.0</div>
        </div>
            ...
            {DADOS.map(([k, v], i) => (
              <div
                ...
                className={`flex justify-between py-2.5 text-[13px] ${
                  i < DADOS.length - 1 ? "border-b border-(--color-border-soft)" : ""
                }`}
              >
            ...
            <CardContent>
              ...
              {PLANO.map(([k, v], i) => (
                <div
                  key={i}
                  className={`flex justify-between py-2.5 text-[13px] ${
                    i < PLANO.length - 1 ? "border-b border-(--color-border-soft)" : ""
                  }`}
                >
