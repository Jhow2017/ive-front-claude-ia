  ...
  return (
    <>
      ...
      <div className="grid lg:grid-cols-[1.5fr_1fr] gap-3.5">
        <Card
          style={{
            background: emAtend ? "linear-gradient(135deg, var(--color-g50), #fff)" : "#fff",
            ...
            {emAtend ? (
              <div>
                <div className="flex items-center gap-3.5 mb-5">
                  ...
                  />
                  <div>
                    <div className="text-[22px] font-extrabold">{emAtend.name}</div>
                ...
                >
                  <CheckCircle size={16} />
                  Finalizar sessão
                  {autoNext && aguardando.length > 0 && ` e chamar ${aguardando[0].name.split(" ")[0]}`}
                </Button>
              </div>
            ) : (
          ...
          <div className="grid gap-2">
            {aguardando.map((p, i) => (
              ...
              >
                ...
                <Button variant="outline" size="sm" onClick={() => chamar(p.id)} disabled={!!emAtend}>
