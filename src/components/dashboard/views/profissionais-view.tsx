...
const PROFS: Prof[] = [
    ...
    },
    {
        ...
        patients: 22,
        phone: "(11) 98765-1234",
        email: "rafael.cunha@iverde.com.br",
    },
    {
        seed: 2,
        name: "Profa. Cíntia Rocha",
        spec: "Terapia Ocupacional",
        reg: "CREFITO 67890/SP",
        patients: 31,
        phone: "(11) 98765-5678",
        email: "cintia.rocha@iverde.com.br",
    },
    {
        seed: 3,
        ...
        patients: 19,
        phone: "(11) 98765-9012",
        email: "mariana.souza@iverde.com.br",
    },
    {
        seed: 4,
        name: "Dr. Carlos Melo",
        ...
        patients: 15,
        phone: "(11) 98765-3456",
        email: "carlos.melo@iverde.com.br",
    },
    {
        seed: 5,
        name: "Profa. Letícia Nunes",
        spec: "Psicomotricidade",
        reg: "ABPsim 44556/SP",
        patients: 18,
        phone: "(11) 98765-7890",
        email: "leticia.nunes@iverde.com.br",
    },
];
                ...
                {filtered.map((p, i) => (
                    ...
                    >
                        <div className="flex items-start justify-between gap-2 mb-3.5 min-w-0">
                            <div className="flex gap-3 items-start min-w-0">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <div className="text-[11px] text-(--color-muted2) mt-0.5 truncate">
                                        {p.reg}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="bg-(--color-g50) rounded-[9px] px-3.5 py-2.5 mb-3.5">
                            ...
                            <div className="text-2xl font-extrabold text-(--color-g500) tracking-tight">
                                {p.patients}
                            </div>
                        </div>
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-3.5">
                            ...
                            <div className="bg-white border border-(--color-border-soft) rounded-xl p-4">
                                ...
                                <div className="text-2xl font-extrabold text-(--color-g500)">
                                    4.9
                                </div>
                            </div>
                        </div>
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <FormField label="Especialidade">
                                <Input defaultValue={edit.spec} />
                            </FormField>
                            <FormField label="Registro">
                                <Input defaultValue={edit.reg} />
                            </FormField>
