...
const NOTIFS = [
    {
        ...
        msg: "Lucas Costa confirmou a sessão de Fonoaudiologia para amanhã às 14h.",
        time: "há 12 min",
        unread: true,
    },
    {
    ...
    },
    {
        ...
        msg: "Plano terapêutico do Pedro Santos foi aprovado pela coordenação.",
        time: "há 3h",
        unread: true,
    },
    {
        ...
        msg: "A sessão das 09h com Maria Oliveira foi cancelada pela família.",
        time: "ontem",
        unread: false,
    },
    {
        ...
        msg: "Avaliação neuropsicológica de Ana Lima finalizada.",
        time: "ontem",
        unread: false,
    },
];
                                ...
                                {NOTIFS.map((n, i) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="text-xs text-(--color-muted) leading-snug">
                                                {n.msg}
                                            </div>
                                            <div className="text-[10px] text-(--color-muted2) mt-1">
                                                {n.time}
                                            </div>
                                        </div>
                                    </div>
