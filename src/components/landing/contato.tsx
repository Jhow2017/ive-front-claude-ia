...
export function Contato() {
  ...
  const form = useForm<z.infer<typeof schema>>({
    ...
    defaultValues: { nome: "", telefone: "", email: "", assunto: "Agendamento de consulta", mensagem: "" },
  });
      ...
      <div className="wrap">
        <div className="grid lg:grid-cols-2 gap-16">
          <div>
            ...
            <h2 className="text-[38px] font-extrabold tracking-tight leading-[1.18] mb-4">Fale com a gente</h2>
            <p className="text-(--color-muted) text-[15px] leading-relaxed mb-8">
              Para agendamentos, dúvidas sobre o processo ou informações sobre doações. Respondemos em até 1 dia útil.
            </p>
          ...
          <div>
            {sent ? (
              <div className="bg-(--color-g50) border border-(--color-g100) rounded-2xl p-10 text-center">
                ...
                <div className="text-(--color-muted) text-sm">Retornaremos em até 1 dia útil.</div>
              </div>
            ) : (
                ...
                >
                  <div className="grid grid-cols-2 gap-3.5">
                    ...
                    <FormField label="Telefone">
                      <Input placeholder="(11) 9xxxx-xxxx" {...form.register("telefone")} />
                    </FormField>
                  </div>
                  ...
                  <FormField label="Mensagem">
                    <Textarea placeholder="Descreva brevemente o que precisa..." {...form.register("mensagem")} />
                  </FormField>
