...
const COLS = [
  ...
  { h: "Plataforma", ls: ["Área da família", "Área do profissional", "Fazer login", "Criar conta"] },
          ...
          <div className="col-span-2">
            <div className="flex items-center gap-2.5 mb-2.5">
              ...
              <div className="text-[15px] font-extrabold text-white">
                Instituto <em className="text-(--color-g200) not-italic">Verde</em> Esperança
              </div>
            </div>
            <div className="text-[13px] text-white/40 leading-relaxed max-w-md">
              Atendimento multidisciplinar especializado em crianças autistas, com plataforma integrada para
          ...
          {COLS.map((col) => (
            <div key={col.h}>
              ...
              <ul className="list-none flex flex-col gap-2.5">
                {col.ls.map((l) => (
                  <li key={l}>
                    <a href="#" className="text-[13px] text-white/40 hover:text-white transition-colors no-underline">
                      {l}
                    </a>
                  </li>
                ))}
