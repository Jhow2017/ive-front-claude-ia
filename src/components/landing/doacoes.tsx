          ...
          <div>
            ...
            <div className="flex flex-col gap-4 text-[15px] text-white/75 leading-[1.85]">
              <p>
                ...
                <strong className="text-white">Programa de Acesso Social</strong> — que oferece atendimento gratuito
                ou subsidiado para famílias em vulnerabilidade socioeconômica.
              </p>
              <p>
                Toda doação é registrada e auditável. Publicamos um{" "}
                <strong className="text-white">relatório de impacto semestral</strong> com valores recebidos,
                crianças atendidas e resultados observados.
              </p>
              <p>
                Em 2024, o programa atendeu <strong className="text-white">47 crianças</strong> que não teriam acesso
                ao tratamento de outra forma.
              </p>
            </div>
            <Button
              size="xl"
          ...
          <div className="flex flex-col gap-3.5">
            {STATS.map((s, i) => (
              ...
              >
                ...
                <div>
                  <div className="text-[22px] font-extrabold text-white tracking-tight">{s.v}</div>
                  <div className="text-xs text-white/60 mt-0.5 leading-snug">{s.l}</div>
                </div>
              </div>
            ))}
          </div>
