                ...
                <div className="grid sm:grid-cols-3 gap-5 mt-14">
                    <Card title="Missão" emoji="🎯">
                        <p className="text-sm text-white/72 leading-relaxed">
                            Oferecer atendimento especializado em autismo com processo clínico
                            integrado — onde a família faz parte do tratamento, não apenas assiste.
                        </p>
                    </Card>
                    <Card title="Visão" emoji="🔭">
                        <p className="text-sm text-white/72 leading-relaxed">
                            Ser referência em atendimento multidisciplinar para crianças autistas no
                            Brasil, com modelo replicável que combina qualidade clínica e tecnologia
                            acessível.
                        </p>
                    </Card>
                    <Card title="Valores" emoji="⚖️">
                        <ul className="list-none flex flex-col gap-2.5">
                            {VALORES.map((v) => (
                                <li
                                    key={v}
                                    className="text-[13px] text-white/70 flex items-start gap-2 leading-snug"
                                >
                                    <Check
                                        size={12}
