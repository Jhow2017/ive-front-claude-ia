...
export function IllusTherapy() {
    return (
        <svg viewBox="0 0 380 320" className="w-full max-w-[380px] overflow-visible">
            ...
            <text x="160" y="175" fontSize="16" className="animate-float-slow">
                ✨
            </text>
...
export function IllusBlocks() {
    return (
        <svg viewBox="0 0 380 320" className="w-full max-w-[380px] overflow-visible">
            ...
            />
            <text x="250" y="247" fontSize="18" textAnchor="middle" fill="white" fontWeight="800">
                A
            </text>
            <rect
                x="234"
            ...
            />
            <text x="253" y="202" fontSize="16" textAnchor="middle" fill="white" fontWeight="800">
                B
            </text>
            <rect
                x="238"
            ...
            />
            <text x="254" y="163" fontSize="14" textAnchor="middle" fill="white" fontWeight="800">
                C
            </text>
            <rect
                x="103"
            ...
            />
            <text x="120" y="207" fontSize="14" textAnchor="middle" fill="white" fontWeight="800">
                D
            </text>
            <rect x="88" y="264" width="36" height="36" rx="7" fill="#6ee7b7" />
            <text x="106" y="287" fontSize="16" textAnchor="middle" fill="#065f46" fontWeight="800">
                E
            </text>
            <g className="animate-float-slow">
            ...
            <text x="258" y="128" fontSize="20" className="animate-float">
                🌟
            </text>
        </svg>
    );
...
export function IllusPainting() {
    return (
        <svg viewBox="0 0 380 320" className="w-full max-w-[380px] overflow-visible">
            ...
            <path
                d="M118 125 Q148 102 178 118 Q205 132 220 112"
                stroke="#f472b6"
                strokeWidth="3"
                fill="none"
                strokeLinecap="round"
