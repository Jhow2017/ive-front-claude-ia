                ...
                <div className="grid lg:grid-cols-2 gap-20 items-start">
                    <div>
                        ...
                        <div className="flex flex-col gap-4 text-[15px] text-(--color-muted) leading-[1.85]">
                            <p>
                                Fundado em 2021, o Instituto Verde Esperança surgiu de uma
                                constatação prática: famílias com crianças autistas enfrentavam
                                processos longos de diagnóstico, atendimento fragmentado entre
                                clínicas e dificuldade para entender o que estava acontecendo no
                                tratamento do filho.
                            </p>
                            <p>
                                Nossa resposta foi centralizar especialidades complementares em um
                                único espaço — e desenvolver uma plataforma para que pais acompanhem
                                o processo com clareza, não apenas recebam relatórios mensais.
                            </p>
                            <p>
                                Não somos uma clínica genérica. Somos um instituto com foco
                                definido, protocolo próprio e um sistema que conecta equipe clínica
                                e família de forma contínua.
                            </p>
                        </div>
                    </div>
                    <div className="flex flex-col gap-3.5">
                        {HIGHS.map((h, i) => (
                            ...
                            >
                                <h4 className="text-sm font-bold text-(--color-g700) mb-1.5">
                                    {h.t}
                                </h4>
