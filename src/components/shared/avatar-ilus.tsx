...
export function AvatarIlus({ seed = 0, size = 32 }: { seed?: number; size?: number }) {
    ...
    return (
        <svg
            ...
            height={size}
            viewBox="0 0 64 64"
            className="rounded-full bg-(--color-g50) shrink-0"
        >
            ...
            {isLong ? (
                <>
                    <path
                        d="M18 26 Q22 14 32 14 Q42 14 46 26 L46 36 Q44 32 42 32 L22 32 Q20 32 18 36 Z"
                        fill={hr}
                    />
                ...
                <path
                    d="M18 26 Q22 14 32 14 Q42 14 46 26 L46 30 Q40 22 32 22 Q24 22 18 30 Z"
                    fill={hr}
                />
            )}
